...
class GameController: UIViewController {
    ...
    func gameInit() {
        ...
        allButtons = [greenChipLabel, redChipLabel, blueChipLabel, blackChipLabel, dealButtonLabel, doubleButtonLabel, hitButtonLabel, standButtonLabel, clearButtonLabel]
    ...
    func flipCardFour() {
        ...
        //Handles dealing/flipping any card
